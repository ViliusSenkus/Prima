...
function createPage(){
    ...
    let styleGeneral4 ='a{text-decoration: none;color:  rgb(36, 49, 53);}li:hover{background-image:linear-gradient(to right, rgb(183, 250, 255),  white 30%);}';
    let styleGeneral5 ='#btn{display:none;}</style>';
    let styleGeneral = styleFormal+styleGeneral1+styleGeneral2+styleGeneral3+styleGeneral4+styleGeneral5;
